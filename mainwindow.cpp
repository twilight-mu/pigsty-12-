...
void searchsty(pigsty ps[],int i)
{
    ...
    if(p==NULL)
    {
        cout<<"The pigsty is empty!"<<endl;
        return;
    }
    if(isblack==1)
    {
        cout<<"The pigsty is black,it has "<<sum<<" black pigs."<<endl;
    }
    else
    {
        cout<<"The pigsty is not black, it has "<<sum<<" pigs."<<endl;
        int pig2=0,pig3=0;
        while(p)
        {
            if(p->species==2)
        ...
        cout<<"Among these pigs,there are "<<pig2<<" small white pigs and "<<pig3<<" big white flower pigs."<<endl;
    }
}
void searchpig(pigsty ps[],int i,int j)
{
    ...
    if(flag==1)
    {
        ...
        cout<<"This pig is ";
        if(sp==1)
        cout<<"a black pig."<<endl;
        if(sp==2)
        cout<<"a small white pig."<<endl;
        if(sp==3)
        cout<<"a big white pig."<<endl;
        cout<<"The growth day of this pig is "<<gd<<" days."<<endl;
        cout<<"The weight of this pig is "<<w<<" kg."<<endl;
    }
    else
    {
        cout<<"Can not find this pig!"<<endl;
    }
}
void printallsty(pigsty ps[])
{
    ...
    cout<<"blackpig:"<<allpig1<<"  small white pig:"<<allpig2<<"  big white pig:"<<allpig3<<endl;
    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->store,&QPushButton::clicked,this,&MainWindow::close);//储存游戏并退出

    connect(ui->tuichu,&QPushButton::clicked,this,&MainWindow::close);//关闭游戏
    ...
    connect(ui->growday,&QPushButton::clicked,//增长天数
            [=]()
    {
        bool ok;
